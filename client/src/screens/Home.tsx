  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="SchoolMeet is a real-time video chat application for connecting, chatting, collaborating, sharing screens, and exchanging messages."
        />
        <meta
          name="keywords"
          content="SchoolMeet, video chat, random chat, video call, screen sharing, real-time messaging"
        />
      </Helmet>
